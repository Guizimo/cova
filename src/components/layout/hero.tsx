    ...
    <section className="relative w-full pt-32">
      <div className="mx-auto max-w-[1000px] px-6">
        <div className="flex flex-col w-full">
          ...
          <p className="text-lg text-white/60 max-w-xl mb-8">{t('hero.description')}</p>

          <div className="flex flex-col sm:flex-row gap-4 mb-12 z-10">
            <Link to="/generator">
              <Button size="lg" className="h-12 px-6 bg-white text-black hover:bg-white/90 rounded-lg cursor-pointer">
                {t('hero.getStarted')}
            ...
            <Link to="/about">
              <Button
                variant="outline"
                size="lg"
                className="h-12 px-6 border-white/10 bg-white/5 text-white hover:bg-white/10 hover:text-white rounded-lg cursor-pointer"
              >
                {t('hero.viewAbout')}
              </Button>
            </Link>
