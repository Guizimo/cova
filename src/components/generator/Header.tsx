...
import { Download, ListRestart, Share2, Home, Globe, Check } from 'lucide-react';
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
      ...
      <div className="flex h-full items-center justify-between px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Button
            ...
            className="border-white/[0.08] bg-white/[0.05] text-white hover:bg-white/[0.1] hover:text-white h-8"
          >
